...
class CourseClass:
    def __init__(self, root):
        ...
        # ======Widgets========
        ibl_courseName = Label(self.root, text="Course Name", font=("goudy old style", 15, "bold"), bg="white").place(
            x=10, y=60)
        ibl_duration = Label(self.root, text="Duration", font=("goudy old style", 15, "bold"), bg="white").place(x=10,
                                                                                                                 y=100)
        ibl_charges = Label(self.root, text="Charges", font=("goudy old style", 15, "bold"), bg="white").place(x=10,
                                                                                                               y=140)
        ibl_description = Label(self.root, text="Description", font=("goudy old style", 15, "bold"), bg="white").place(
            x=10, y=180)
        ...
        # ====search panel=========
        ibl_search_courseName = Label(self.root, text="Search Course", font=("goudy old style", 15, "bold"),
